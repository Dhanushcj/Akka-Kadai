            ...
            <div className="hidden lg:grid grid-cols-8 gap-4 px-8 py-5 items-center">
               ...
               <div className="flex justify-end gap-1.5">
                  {loan.status === 'Active' && (
                   ...
                   <button onClick={() => { setCurrentLoanForHistory(loan); setIsHistoryModalOpen(true); }} title="Payment History" className="p-2 bg-slate-800 text-slate-400 border border-border-subtle rounded-lg hover:text-white transition-all">
